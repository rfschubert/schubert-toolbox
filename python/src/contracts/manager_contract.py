...
from typing import Any, Dict, List, Optional, Protocol, runtime_checkable, Union, Type
...
class DriverNotFoundError(ManagerError):
    ...
    def __init__(self, driver_name: str, available_drivers: Optional[List[str]] = None):
