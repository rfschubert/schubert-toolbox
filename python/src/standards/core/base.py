...
class Country:
    ...
    code: Optional[str] = None  # ISO 3166-1 alpha-2 (US, BR, etc.)
    alpha3: Optional[str] = None  # ISO 3166-1 alpha-3 (USA, BRA, etc.)
    numeric: Optional[str] = None  # ISO 3166-1 numeric (840, 076, etc.)
    name: Optional[str] = None  # English name
    local_name: Optional[str] = None  # Localized name
